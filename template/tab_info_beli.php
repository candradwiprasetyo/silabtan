...
<?php
	...
	if($komentar != '' ){
		...
		if($komentar != ''){ // and $commentup != ''){
			$query = mysql_query("INSERT INTO tsilabtan_status(username,  status, tsi_idstatus, datecreated, generalsellorneedorinfo) VALUES('$email','$komentar','$commentup','$time','$jualbeli')");
		...
		if($jualbeli = "market"){
			$query = mysql_query("INSERT INTO tsilabtan_need(kota, idstatus, idmeasureunit,quantity) VALUES('$idcity', '$idstatus','$idsatuan2','$stock')");
          ...
          <div class='panel panel-default panel-timeline'>
            ...
            <div class='panel-body'>
                ...
                <div class='media-body'>
                  ...
                  <p>".$hasilKomen['status']."<br>".$hasilKomen['kota'].$hasilKomen['berita']."</p>
                </div>
              </div>
