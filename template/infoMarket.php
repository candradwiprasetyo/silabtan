...
<script>
	function showJual()
	{
		...
		//alert(nama);
		xmlhttp.open("GET", "ajaxMarketTest.php", true);
		//+"&strID="+strID, true);
		//&nama="+nama,true);
		xmlhttp.send();
...
<div class="contentpanel">
	...
	<div class="row" style="max-width: 100%;max-height: 100%;padding:0px 0px">
				...
				<form id="form" name="form">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<option value=""></option>
								<?php 
								$query = mysql_query("SELECT m.idmarket, concat(m.nameofmarket,', ',c.nameofcity) AS kota
										  FROM tsilabtan_market m 
										  INNER JOIN tsilabtan_city c ON (c.idcity = m.idcity)
										  WHERE m.NAMEOFMARKET LIKE '%$name%'
										");
										echo "SELECT m.idmarket, concat(m.nameofmarket,', ',c.nameofcity) AS kota
										  FROM tsilabtan_market m 
										  JOIN tsilabtan_city c ON (c.idcity = m.idcity)
										  WHERE m.NAMEOFMARKET LIKE '%$name%'
										";
	                    ...
	                    <div class="form-group">
							...
							<div class="col-sm-7" style="padding-right: 6px;">
		...
		<div class="col-sm-6">
			<?php 
				include 'highchart_infomarket.php';
				include 'highchart_infomarket2.php';
			?>
		</div>
	</div>
</div>
