 ...
 */
(function(){
	var M,K,L=Math.abs,ah=Math.sin,w=Math.cos,s=Math.max,
	aD=Math.min,ap=Math.ceil,F=Math.sqrt,at=Math.pow,
	h={},l={},m={0:"0,",1:"17,",2:"34,",3:"51,",4:"68,",5:"85,",
	...
	function aA(){return false}function G(){
	...
	function an(j){
		var aI=j.length-1,aH,aJ;while(aI){
		aJ=~~(Math.random()*aI);
		aH=j[aI];j[aI]=j[aJ];
		j[aJ]=aH;--aI
		}
	...
	H.cross=function(j){
		var i=this.y*j.z-this.z*j.y,aI=this.z*j.x-this.x*j.z,aH=this.x*j.y-this.y*j.x;
		return new ae(i,aI,aH)
	};
	H.angle=function(j){
		var i=this.dot(j),aH;if(i==0){
			return Math.PI/2
		}
	...
	function aj(aH,j){
		j=j*Math.PI/180;aH=aH*Math.PI/180;
		var i=ah(aH)*w(j),aJ=-ah(j),aI=-w(aH)*w(j);
	...
	R.Rotation=function(aI,i){
		...
		aF.xform=function(aH){
			...
			function q(aI,aK,aP,aM){
				var aL,aO,j,aN,aQ=[],aJ=Math.PI*(3-F(5)),aH=2/aI;
				for(aL=0;aL<aI;++aL){
					aO=aL*aH-1+(aH/2);
					j=F(1-aO*aO);
					aN=aL*aJ;
			...
			function W(aJ,aH,aM,aS,aQ){
				var aR,aT=[],aK=Math.PI*(3-F(5)),aI=2/aJ,aP,aO,aN,aL;
				for(aP=0;aP<aJ;++aP){
					aO=aP*aI-1+(aI/2);
					aR=aP*aK;aN=w(aR);
					aL=ah(aR);
			...
			function U(aK,i){
				...
				return aJ}function P(i,j){
					if(window.G_vmlCanvasManager){
						return null
					}
					var aH=C.createElement("canvas");
					aH.width=i;aH.height=j;
					return aH
				}
				function al(){
					var j=P(3,3),aI,aH;
				...
				function X(aQ,aJ,j,aU,aT,aR,aP,aL,aI,aS,aK,aO){
					...
					aQ.font=aJ;
					aQ.textBaseline="top";aQ.fillStyle=j;
					aP&&(aQ.shadowColor=aP);aL&&(aQ.shadowBlur=aL);
				...
				function g(aN,i,aL,aI,aM,aH,aJ,aK,j){
					this.strings=aN;this.font=i;
					this.width=aL;this.height=aI;
					this.maxWidth=aM;this.stringWidths=aH;
					this.align=aJ;
					this.valign=aK;
					this.scale=j}aa=g.prototype;
					aa.SetImage=function(aK,j,aI,i,aJ,aM,aH,aL){
						...
						aa.Align=function(j,aH,i){
							var aI=0;
							if(i=="right"||i=="bottom"){aI=aH-j}
							else{
								if(i!="left"&&i!="top"){aI=(aH-j)/2}
							}
							return aI
						};
						aa.Create=function(aU,a0,aT,a1,aZ,aY,i,aX,aP){
							...
							if(this.image){
								...
								if(this.ipos=="top"||this.ipos=="bottom"){
									...
									else{aH+=this.Align(this.width,aO,this.align)}
									if(this.ipos=="top"){j+=aW+this.ipad}
									else{aK+=this.height+this.ipad}
									aL=s(aL,aO+a3);
									aV+=aW+this.ipad
								}
								else{
									...
									if(this.ipos=="right"){aM+=this.width+this.ipad}
									else{aH+=aO+this.ipad}
									aL+=aO+this.ipad;
									aV=s(aV,aW+aJ)
								}
							}
							...
							aS=aD(aP,a2/2,aI/2);
							a6=aN.getContext("2d");
							if(a0){a6.fillStyle=a0;ar(a6,a3,aJ,a2,aI,aS)}
							if(a1){a6.strokeStyle=aT;a6.lineWidth=a1;ar(a6,a3,aJ,a2,aI,aS,true)}
							...
							if(this.image){a6.drawImage(this.image,aM,aK,aO,aW)}
							if(aR){
								a6=aR;
						...
						function aC(aU,aP,aV,aZ,aQ,aO,aM,aS,aK,aL){
							...
							if(!aJ){return null}
							aO*=aZ;aK*=aZ;aX=aH=aO/2;
							aW=aI-aO;j=aR-aO;
							aS=(aS*aZ)+aX;
							aY=aJ.getContext("2d");aN=aD(aK,aW/2,j/2);
							if(aQ){aY.fillStyle=aQ;ar(aY,aX,aH,aW,j,aN)}
							if(aO){aY.strokeStyle=aM;aY.lineWidth=aO;ar(aY,aX,aH,aW,j,aN,true)}
							if(aL){
								a0=P(aI,aR);
								aT=a0.getContext("2d");
								aT.drawImage(aU,aS,aS,aP,aV);
								aT.globalCompositeOperation="source-in";
								aT.fillStyle=aM;aT.fillRect(0,0,aI,aR);
								aT.globalCompositeOperation="destination-over";
								aT.drawImage(aJ,0,0);
								aT.globalCompositeOperation="source-over";
								aY.drawImage(a0,0,0)
							}
							else{aY.drawImage(aU,aS,aS,aU.width,aU.height)}
							return{image:aJ,width:aI/aZ,height:aR/aZ}
						}
						function aq(aK,j,aJ,aN,aO){
							var aL,aM,aH=parseFloat(j),aI=s(aJ,aN);aL=P(aJ,aN);
							if(!aL){return null}
							if(j.indexOf("%")>0){aH=aI*aH/100}
							else{aH=aH*aO}
							aM=aL.getContext("2d");
						...
						function Z(aN,aT,aP,aJ,aR,aS,aI){
							...
							aL=P(aK,j);if(!aL){return null}aQ=aL.getContext("2d");
						...
						function t(aT,aL,aR){
							...
							j=aO.getImageData(0,0,aS,aK);aJ=j.width;
							aN=j.height;aM={min:{x:aJ,y:aN},max:{x:-1,y:-1}};
							for(aP=0;aP<aN;++aP){
								for(aQ=0;aQ<aJ;++aQ){
									aH=(aP*aJ+aQ)*4;
									if(j.data[aH+1]>0){
										if(aQ<aM.min.x){aM.min.x=aQ}
						...
						function a(i,j,aH){
							...
							else{aH.detachEvent("on"+i,j)}
						}
						function aw(aL,aH,aP,aK){
							var aQ=aK.imageScale,aN,aI,aM,j,aJ,aO;
							if(!aH.complete){return ad("load",function(){aw(aL,aH,aP,aK)},aH)}
							if(!aL.complete){return ad("load",function(){aw(aL,aH,aP,aK)},aL)}
							aH.width=aH.width;aH.height=aH.height;
							if(aQ){
							...
							aP.ih=aL.height;
							if(aK.txtOpt){
								aI=aL;aN=aK.zoomMax*aK.txtScale;
								aJ=aP.iw*aN;aO=aP.ih*aN;
								if(aJ<aH.naturalWidth||aO<aH.naturalHeight){
									aI=ax(aL,aJ,aO);if(aI){aP.fimage=aI}
								}
								else{aJ=aP.iw;aO=aP.ih;aN=1}
								...
								if(!aP.HasText()){
									if(aK.shadow){
										...
										if(aI){aP.fimage=aI.image;aP.w=aI.width;
										aP.h=aI.height}
									}
									if(aK.bgColour||aK.bgOutlineThickness){
										...
										if(aK.outlineMethod=="colour"){
											...
											if(aI){aP.oimage=aI.image}
										}
										aI=aC(aP.fimage,aJ,aO,aN,aM,aK.bgOutlineThickness,j,aK.padding,aK.bgRadius);
										if(aI){aP.fimage=aI.image;aP.w=aI.width;aP.h=aI.height}
									}
									if(aK.outlineMethod=="size"){
										if(aK.outlineIncrease>0){
											aP.iw+=2*aK.outlineIncrease;aP.ih+=2*aK.outlineIncrease;aJ=aN*aP.iw;
											aO=aN*aP.ih;aI=ax(aP.fimage,aJ,aO);
											aP.oimage=aI;aP.fimage=v(aP.fimage,aP.oimage.width,aP.oimage.height)
										}
										else{
						...
						function Y(aI,aH){
							var j=C.defaultView,i=aH.replace(/\-([a-z])/g,function(aJ){
						...
						function u(j,aI,aH){
							var i=1,aJ;
							if(aI){i=1*(j.getAttribute(aI)||aH)}
							else{
								if(aJ=Y(j,"font-size")){
						...
						function S(aJ,aK){
							...
							if(ai(aJ.offsetX)){
								aI={x:aJ.offsetX,y:aJ.offsetY}
							}
						else{
							aH=ab(aK.id);
							if(ai(aJ.changedTouches)){aJ=aJ.changedTouches[0]}
						...
						function B(aH){
							var j=aH.target||aH.fromElement.parentNode,i=y.tc[j.id];
							if(i){i.mx=i.my=-1;i.UnFreeze();i.EndDrag()}
						}
						function af(aL){
							...
							if(aJ&&aH.tc[aJ]){
								j=aH.tc[aJ];
								if(aK=S(aL,j.canvas)){j.mx=aK.x;j.my=aK.y;j.Drag(aL,aK)}
								j.drawn=0
							}
						}
						function z(aI){
							var j=y,i=C.addEventListener?0:1,aH=f(aI);
							if(aH&&aI.button==i&&j.tc[aH]){j.tc[aH].BeginDrag(aI)}
						}
						function aE(aJ){
							...
							if(aI&&aJ.button==j&&aH.tc[aI]){
								i=aH.tc[aI];
								af(aJ);
								if(!i.EndDrag()&&!i.touchState){i.Clicked(aJ)}
							}
						}
						function T(aI){
							...
							if(i&&aI.changedTouches){
								if(aI.touches.length==1&&i.touchState==0){
									...
									else{i.EndDrag();i.EndPinch();i.touchState=0}
								}
							}
						}
						function r(aH){
							var j=f(aH),i=(j&&y.tc[j]);
						...
						function az(aL){
							...
							if(j&&aL.changedTouches&&j.touchState){
								switch(j.touchState){
									case 1:case 2:if(aK=S(aL,j.canvas)){
										j.mx=aK.x;j.my=aK.y;
										if(j.Drag(aL,aK)){
											j.touchState=2
										}
						...
						function ac(aI){
							var aH,j=y;clearTimeout(j.scrollTimer);
							for(aH in j.tc){j.tc[aH].Pause()}
						...
						function O(){E(G())}
						function E(aI){
							var j=y.tc,aH;y.NextFrame(y.interval);
							aI=aI||G();
							for(aH in j){
								j[aH].Draw(aI)
							}
						...
						function ab(aH){
							var aK=C.getElementById(aH),i=aK.getBoundingClientRect(),aN=C.documentElement,aL=C.body,aM=window,aI=aM.pageXOffset||aN.scrollLeft,aO=aM.pageYOffset||aN.scrollTop,aJ=aN.clientLeft||aL.clientLeft,j=aN.clientTop||aL.clientTop;
							return{x:i.left+aI-aJ,y:i.top+aO-j}
						}
						function V(j,aI,aJ,aH){
							var i=j.radius*j.z1/(j.z1+j.z2+aI.z);
							return{x:aI.x*i*aJ,y:aI.y*i*aH,z:aI.z,w:(j.z1-aI.z)/j.z2}
						}
						function aB(i){
							this.e=i;
							this.br=0;
							this.line=[];
							this.text=[];
							this.original=i.innerText||i.textContent}aG=aB.prototype;
							aG.Empty=function(){
							...
							aG.Lines=function(aJ){
								...
								aG.SplitWidth=function(aH,aO,aL,aK){
									...
									x.SetMethod=function(aH){
										var j={block:["PreDraw","DrawBlock"],colour:["PreDraw","DrawColour"],outline:["PostDraw","DrawOutline"],classic:["LastDraw","DrawOutline"],size:["PreDraw","DrawColour"],none:["LastDraw"]},i=j[aH]||j.outline;
										if(aH=="none"){
											this.Draw=function(){return 1}
										}
										else{this.drawFunc=this[i[1]]}
										this[i[0]]=this.Draw
									};
									x.Update=function(aN,aM,aO,aJ,aK,aL,aI,i){
										var j=this.tc.outlineOffset,aH=2*j;
										this.x=aK*aN+aI-j;this.y=aK*aM+i-j;
										this.w=aK*aO+aH;this.h=aK*aJ+aH;
										this.sc=aK;this.z=aL};
										x.DrawOutline=function(aL,i,aK,j,aH,aJ){
											var aI=aD(this.radius,aH/2,j/2);
											aL.strokeStyle=aJ;ar(aL,i,aK,j,aH,aI,true)};
											x.DrawColour=function(aI,aL,aJ,aM,aH,i,aN,j,aK){
												if(aN.oimage){
													aN.alpha=1;aN.Draw(aI,j,aK,aN.oimage);
													return 1
												}
												...
												x.DrawColourImage=function(aM,aP,aN,aQ,aL,i,aT,j,aO){
													...
													aT.alpha=1;aT.Draw(aM,j,aO);
													aM.setTransform(1,0,0,1,0,0);
													aM.save();aM.beginPath();
													aM.rect(aJ,aI,aK,aS);
													aM.clip();
													aM.globalCompositeOperation="source-in";
													aM.fillStyle=i;
												...
												x.DrawBlock=function(aL,i,aK,j,aH,aJ){
													...
													x.DrawSimple=function(aJ,i,j,aI){
														var aH=this.tc;aJ.setTransform(1,0,0,1,0,0);
													...
													c.Init=function(j){
														...
														c.SetDraw=function(i){
															...
															c.MeasureText=function(aK){
																...
																for(aI=0;aI<aH;++aI){
																	this.line_widths[aI]=aJ=aK.measureText(this.text[aI]).width;j=s(j,aJ)
																}
																return j
															};
															c.Measure=function(aM,aP){
																...
																if(aP.txtOpt){
																	...
																	aM.font=aJ;aH=this.MeasureText(aM);
																	...
																	if(aI){
																		...
																		aO=this.fimage.height/aQ}this.SetDraw(aP);
																		aP.txtOpt=!!this.fimage}this.h=aO;
																		this.w=aL};
																		...
																		c.SetShadowColourFixed=function(aH,j,i){aH.shadowColor=j};
																		c.SetShadowColourAlpha=function(aH,j,i){aH.shadowColor=U(j,i)};
																		c.DrawText=function(aJ,aM,aI){
																			...
																			for(j=0;j<this.text.length;++j){
																				...
																				c.DrawImage=function(aJ,aQ,aI,aL){
																					var aN=this.x,aK=this.y,aR=this.sc,j=aL||this.fimage,aO=this.w,aH=this.h,aM=this.alpha,aP=this.shadow;
																					aJ.globalAlpha=aM;
																					aP&&this.SetShadowColour(aJ,aP,aM);
																					aN+=(aQ/aR)-(aO/2);aK+=(aI/aR)-(aH/2);
																					aJ.setTransform(aR,0,0,aR,aR*aN,aR*aK);
																					aJ.drawImage(j,0,0,aO,aH)};
																					c.DrawImageIE=function(aJ,aN,aI){
																						var j=this.fimage,aO=this.sc,aM=j.width=this.w*aO,aH=j.height=this.h*aO,aL=(this.x*aO)+aN-(aM/2),aK=(this.y*aO)+aI-(aH/2);
																						...
																						c.UpdateActive=function(aM,aH,aK){
																							var aJ=this.outline,j=this.w,aI=this.h,i=this.x-j/2,aL=this.y-aI/2;
																							aJ.Update(i,aL,j,aI,this.sc,this.z,aH,aK);
																							return aJ
																						};
																						c.CheckActive=function(aJ,i,aI){
																							var j=this.tc,aH=this.UpdateActive(aJ,i,aI);
																							...
																							c.Clicked=function(aK){
																								...
																								function y(aN,j,aI){
																									...
																									this.ctxt.textBaseline="top";this.lx=(this.lock+"").indexOf("x")+1;
																									this.ly=(this.lock+"").indexOf("y")+1;
																									this.frozen=this.dx=this.dy=this.fixedAnim=this.touchState=0;
																									this.fixedAlpha=1;
																									this.source=j||aN;this.repeatTags=aD(64,~~this.repeatTags);
																									...
																									if(j&&this.hideTags){
																										(function(i){
																											if(y.loaded){i.HideTags()}
																											else{
																												ad("load",function(){i.HideTags()},window)
																											}
																										}
																										)
																										(this)
																									...
																									if(!y.started){
																										...
																										Q.UpdateTag=function(aH,i){
																											var aK=this.textColour||Y(i,"color"),j=this.textFont||o(Y(i,"font-family")),aJ=this.bgColour=="tag"?Y(i,"background-color"):this.bgColour,aI=this.bgOutline=="tag"?Y(i,"color"):this.bgOutline;
																											aH.a=i;
																											aH.title=i.title;
																										...
																										Q.Load=function(){
																											var aR=this.GetTags(),aM=[],aP,aQ,aL,aI,aH,j,aJ,aO,aK=[],aN={sphere:q,vcylinder:am,hcylinder:au,vring:d,hring:n};
																											if(aR.length){
																												aK.length=aR.length;
																												...
																												if(this.shapeArgs){
																													...
																													else{this.shape=aN[aP]||aN.sphere}
																											...
																											Q.Update=function(){
																												...
																												if(aQ.length){
																													...
																													if(aM.length){
																														...
																														aM.sort(function(j,i){return j-i});
																														while(aM.length){aP.splice(aM.pop(),1)}
																													}
																													...
																													this.weight&&this.Weight(aP)}this.taglist=aP};
																													...
																													Q.Draw=function(aR){
																														...
																														aK=A(aK,function(aZ,i){return i.z-aZ.z});
																														...
																														if(this.fixedCallback){
																															...
																															this.fixedCallback=null}aM||this.Animate(aJ,aQ,aI);
																															aN&&aN.LastDraw(aX);
																															...
																															Q.Transform=function(aK,i,aM){
																																if(i||aM){
																																	var j=ah(i),aL=w(i),aN=ah(aM),aJ=w(aM),aH=new R([aJ,0,aN,0,1,0,-aN,0,aJ]),aI=new R([1,0,0,0,aL,-j,0,j,aL]);
																															...
																															Q.AnimateDrag=function(j,aJ,aI){
																																var i=this,aH=100*aI*i.maxSpeed/i.max_radius/i.zoom;
																																if(i.dx||i.dy){
																															...
																															Q.Decel=function(i){
																																var aH=i.minSpeed,aI=L(i.yaw),j=L(i.pitch);
																																if(!i.lx&&aI>aH){
																															...
																															Q.Zoom=function(i){
																																this.z2=this.z1*(1/i);this.drawn=0
																															};
																															...
																															Q.Wheel=function(j){
																																...
																																Q.Drag=function(aJ,aI){
																																	if(this.dragControl&&this.down){
																																		var aH=this.dragThreshold*this.dragThreshold,j=aI.x-this.down.x,i=aI.y-this.down.y;
																																...
																																function D(aH){
																																	var j=aH.targetTouches[0],i=aH.targetTouches[1];
																																...
																																Q.Pinch=function(j){
																																	...
																																	Q.EndPinch=function(i){
																																		...
																																		Q.RotateTag=function(aP,aI,aO,i,aM,aH){
																																			var aN=aP.Calc(this.transform,1),aK=new ae(aN.x,aN.y,aN.z),aJ=aj(aO,aI),j=aK.angle(aJ),aL=aK.cross(aJ).unit();
																																			if(j==0){
																																				...
																																				this.fixedAnim={
																																					angle:-j,axis:aL,t:i,t0:G(),cb:aM,tag:aP,active:aH
																																				}
																																			}
																																		};
																																		...
																																		y.Start=function(aH,i,j){
																																			...
																																			function ay(i,j){y.tc[j]&&y.tc[j][i]()}
																																			y.Linear=function(i,j){return j/i};
																																			y.Smooth=function(i,j){return 0.5-w(j*Math.PI/i)/2};
																																			y.Pause=function(i){ay("Pause",i)};
																																			y.Resume=function(i){ay("Resume",i)};
																																			y.Reload=function(i){ay("Load",i)};
																																			y.Update=function(i){ay("Update",i)};
