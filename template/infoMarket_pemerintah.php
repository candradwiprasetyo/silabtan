<div class="pageheader">
	<h2><i class="fa fa-clock-o"></i> Info Market Pemerintah <span>Subtitle goes here...</span></h2>
		...
		<div class="row">
			<div class="panel panel-primary">
				<div class="panel-body">
					<form name="testform" method="post" action="proses_lihat.php" class="form-horizontal form-bordered" enctype="multipart/form-data">
						...
						<div class="form-group">
							<center>
								<input type="submit" name="submit" class="btn btn-primary" value="Lihat"></input>&nbsp;
						...
						<?php
							if (isset($_GET['tanggal']))
							{
								...
								if ($_GET['jenis'] == "konsumen")
								{
									...
									include ('tabel_cek_konsumen_pemerintah.php');
	
								}
								elseif ($_GET['jenis'] == "produsen")
								{
	
									include ('tabel_cek_produsen_pemerintah.php');
								}
								else
								{
								}
