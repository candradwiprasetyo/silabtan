        ...
        <div class="row">
            <div class="col-sm-4 col-lg-3">
                ...
                <ul class="nav nav-pills nav-stacked nav-email mb20">
               	...
               	?>
                <li><a href="<?php echo($base_url."pesan&chat=".$row_user['USERNAME']); ?>"><i class="fa fa-user"></i><?= $row_user['FULLNAME'] ?></a></li>
               	<?php
               	}
               	?>
              </ul>
            ...
            <div class="col-sm-8 col-lg-9">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-footer">
						<center>
							<input type="submit" class="btn btn-primary" value="Sent" ></button>
